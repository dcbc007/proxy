    ...
    var list = s.nodes
        .where(
          (n) =>
              ...
              n.server.toLowerCase().contains(query.toLowerCase()),
        )
        .toList();
          ...
          child: Row(
            children: [
              ...
              IconButton(
                tooltip: '测试全部节点延迟',
                icon: Icon(
                  s.testingAllNodes ? Icons.hourglass_top : Icons.speed,
                  color: AppColors.gold,
                ),
                onPressed: s.testingAllNodes ? null : s.testAllNodeLatencies,
              ),
              IconButton(
              ...
              return Padding(
                ...
                child: ChoiceChip(
                  ...
                  labelStyle: TextStyle(
                    color: on ? AppColors.goldBright : AppColors.text2,
                  ),
                ...
                child: ListTile(
                  ...
                  leading: Container(
                    ...
                    child: Text(
                      _countryCode(n.name),
                      style: TextStyle(
                        color: selected ? AppColors.goldBright : AppColors.text,
                        fontSize: 11,
                    ...
                    children: [
                      GestureDetector(
                        ...
                        child: Text(
                          s.latencyLabel(n),
                          style: TextStyle(
                            color: _latencyColor(n.latencyMs),
                      ...
                      IconButton(
                        ...
                        icon: Icon(
                          ...
                          color: n.favorite ? AppColors.gold : AppColors.text2,
                        ),
                      ),
                      PopupMenuButton<String>(
                        ...
                        onSelected: (value) async {
                          switch (value) {
                            case 'test':
                              await s.testLatency(n);
                              break;
                            case 'edit':
                              if (!context.mounted) return;
                              await Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder: (_) => AddNodeScreen(node: n),
                                ),
                              );
                              break;
                            case 'copy_link':
                              await Clipboard.setData(
                                ClipboardData(text: n.connectionLink),
                              );
                              if (context.mounted) {
